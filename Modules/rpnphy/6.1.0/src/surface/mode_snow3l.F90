...
USE MODD_SNOW_PAR, ONLY : XSNOWTHRMCOND1, XSNOWTHRMCOND2, XSNOWTHRMCOND_AVAP, &
                          ...
                          XSNOWTHRMCOND_S97_1, XSNOWTHRMCOND_S97_2, XSNOWTHRMCOND_S97_3,&
                          XSNOWTHRMCOND_S97_4, XSNOWTHRMCOND_S97_5,&
                          XSNOWTHRMCOND_J91_1, XSNOWTHRMCOND_J91_2, XSNOWTHRMCOND_J91_3,&
                          XSNOWTHRMCOND_J91_4,&
...
ELSEIF(HSNOWCOND == 'C11') THEN
  DO JST = 1,SIZE(PSNOWRHO,2)
    ...
    !
   ENDDO
ELSEIF(HSNOWCOND == 'J91') THEN
  DO JST = 1,SIZE(PSNOWRHO,2)
   !
   DO JJ = 1,SIZE(PSNOWRHO,1)
     PSCOND(JJ,JST) = XSNOWTHRMCOND_J91_1 + (XSNOWTHRMCOND_J91_2 * PSNOWRHO(JJ,JST)) + &
                      (XSNOWTHRMCOND_J91_3 * PSNOWRHO(JJ,JST) * PSNOWRHO(JJ,JST)) * &
                      (XSNOWTHRMCOND_J91_4 - XSNOWTHRMCOND_J91_1)
    ENDDO
    !
   ENDDO
ELSEIF(HSNOWCOND == 'F21') THEN 
  DO JST = 1,SIZE(PSNOWRHO,2)
   !
   DO JJ = 1,SIZE(PSNOWRHO,1)
     PSCOND(JJ,JST) = XSNOWTHRMCOND_F21_1 * (PSNOWRHO(JJ,JST)/XSNOWTHRMCOND_F21_2) * &
                      (PSNOWRHO(JJ,JST)/XSNOWTHRMCOND_F21_2) + XSNOWTHRMCOND_F21_3 * &
                      (PSNOWRHO(JJ,JST)/XSNOWTHRMCOND_F21_2) + XSNOWTHRMCOND_F21_4
   ENDDO
   !
  ENDDO
ELSEIF(HSNOWCOND == 'S97') THEN
  DO JST = 1,SIZE(PSNOWRHO,2)
    !
    DO JJ = 1,SIZE(PSNOWRHO,1)
